      ...
      contents: [
        {
          ...
          parts: [
            {
              text:
                "Extract calendar events as a JSON array. Include 'title', 'description', 'startTime' and 'endTime' with ISO 8601 format (Example: 2024-10-27T14:30:30.000Z), and 'location'. Always convert to UTC time zone. If there is no year, set the current year to" +
                currentYear,
            },
            isPdf
